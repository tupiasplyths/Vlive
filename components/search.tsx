...
import { handleAdd, ChannelData } from '../utils/ResponseHelper';
...
function Search() {
    ...
    const [selectedType, setSelectedType] = useState<'holodex' | 'youtube'>('youtube');
    ...
    const onAddChannel = (item: any) => {
        const channelData: ChannelData = {
            id: item.ChannelIDs,
            name: item.channelTitle,
            thumbnail: item.channelThumbnail,
        };
        handleAdd(channelData, selectedType);
    };

    const renderChannelItem = ({ item }: { item: any }) => (
        <TouchableOpacity
            style={styles.channelItem}
            onPress={() => console.log('Channel selected:', item.ChannelIDs)}
        >
            <Image
    ...
    return (
        <View style={styles.container}>
            <View style={styles.typeSelector}>
                <TouchableOpacity
                    style={[styles.typeButton, selectedType === 'holodex' && styles.typeButtonActive]}
                    onPress={() => setSelectedType('holodex')}
                >
                    <Text style={[styles.typeButtonText, selectedType === 'holodex' && styles.typeButtonTextActive]}>
                        Holodex
                    </Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={[styles.typeButton, selectedType === 'youtube' && styles.typeButtonActive]}
                    onPress={() => setSelectedType('youtube')}
                >
                    <Text style={[styles.typeButtonText, selectedType === 'youtube' && styles.typeButtonTextActive]}>
                        YouTube
                    </Text>
                </TouchableOpacity>
            </View>
